...
class Area extends React.Component {
    ...
    evaluate() {
        const cmap = new Map([
            [0, Number(this.state.constant)],
            [1, Number(this.state.linear)],
            [2, Number(this.state.quadratic)],
            [3, Number(this.state.cubic)],
        ])
        ...
        data['high_low'] = [
            poly1.evaluate(this.state.lower),
            poly1.evaluate(this.state.upper),
        ].toString()
                ...
                <div>
                    ...
                    <div>
                        <InputNumber
                            ...
                            value={this.state.cubic}
                            onChange={this.handleCubic}
                        />{' '}
                        x<sup>3</sup>
                    </div>
                    <div>
                        <InputNumber
                            ...
                            value={this.state.quadratic}
                            onChange={this.handleQuadratic}
                        />{' '}
                        x<sup>2</sup>
                    </div>
                    <div>
                        <InputNumber
                            ...
                            value={this.state.linear}
                            onChange={this.handleLinear}
                        />{' '}
                        x
                    </div>
                    <div>
